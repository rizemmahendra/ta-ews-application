...
// class LineChartWaterLevelWidget extends StatelessWidget {
//   const LineChartWaterLevelWidget({super.key});
...
//               minY: 0,
//               maxY: state.dataHistory.maxValueWaterLevel.toDouble() +
//                   interval(state.dataHistory.maxValueWaterLevel),
//               gridData: FlGridData(
//                 show: true,
//                 drawHorizontalLine: true,
//                 drawVerticalLine: true,
//                 horizontalInterval:
//                     interval(state.dataHistory.maxValueWaterLevel).toDouble(),
//                 verticalInterval: 1,
...
//                             if (value %
//                                         interval(state
//                                             .dataHistory.maxValueWaterLevel) ==
//                                     0 &&
//                                 value.toInt() != 0) {
...
//               lineBarsData: [
//                 LineChartBarData(
//                     spots: state.dataHistory.valueWaterLevelNode1
//                         .asMap()
//                         .entries
...
//                 LineChartBarData(
//                     spots: state.dataHistory.valueWaterLevelNode2
//                         .asMap()
//                         .entries
//                         .map((e) => FlSpot(e.key.toDouble() + 1, e.value))
//                         .toList(),
