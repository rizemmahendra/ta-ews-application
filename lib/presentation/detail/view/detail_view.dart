...
import 'package:ta_ews_application/presentation/detail/widget/history_widget.dart';
...
class _DetailPageState extends State<DetailPage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SungaiBloc, SungaiState>(buildWhen: (previous, current) {
        ...
        return Center(
            child: ListView.builder(
                ...
                itemBuilder: (context, index) =>
                    HistoryContainer(data: state.dataHistory[index])));
      }
